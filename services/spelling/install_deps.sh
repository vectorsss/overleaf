...
echo "deb [arch=amd64] http://mirrors.ustc.edu.cn/ubuntu/ focal main universe" > /etc/apt/sources.list.d/focal-amd.list
...
echo "deb http://mirrors.ustc.edu.cn/debian bullseye main" > /etc/apt/sources.list.d/bullseye.list
